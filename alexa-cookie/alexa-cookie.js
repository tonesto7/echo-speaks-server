...
function AlexaCookie() {
    ...
    const initConfig = () => {
        ...
        _options.debug && console.log('Alexa-Cookie: Use as Login-Amazon-URL: ' + _options.amazonPage);
    ...
    this.generateAlexaCookie = (email, password, __options, webapp, callback) => {
                        ...
                        if (!lastRequestOptions.host.startsWith('alexa') || !lastRequestOptions.path.endsWith('.html')) {
                            ...
                            if (_options.setupProxy) {
                                if (proxyServer) {
                                    ...
                                    amazonProxy.initAmazonProxy(_options, webApp, prepareResult,
                                        (server) => {
                                            if (!server) {
