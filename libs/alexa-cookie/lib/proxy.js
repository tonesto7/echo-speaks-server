...
function initAmazonProxy(_options, callbackCookie, callbackListening) {
    ...
    function router(req) {
        ...
        console.log("Router: " + url + " / " + req.method + " / " + JSON.stringify(req.headers));
